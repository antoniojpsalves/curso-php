<nav class="modulos">
    <div class="modulo verde">
        <h3>1. Básico</h3>
        <ul>
            <li><a href="exercicio.php?dir=basico&file=ola">Olá em PHP</a></li>
            <li><a href="exercicio.php?dir=basico&file=html">Integração HTML</a></li>
            <li><a href="exercicio.php?dir=basico&file=css">Integração CSS</a></li>
            <li><a href="exercicio.php?dir=basico&file=comentarios">Comentários em PHP</a></li>
            <li><a href="exercicio.php?dir=basico&file=desafio">Primeiro Desafio</a></li>
        </ul>
    </div>
    ...
    <div class="modulo azul">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=variaveis&file=desafio_variaveis">Desafio VV</a></li>
    ...
    <div class="modulo laranja">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=array&file=get">Array $_GET</a></li>
            <li><a href="exercicio.php?dir=array&file=post">Array $_POST</a></li>
            <li><a href="exercicio.php?dir=array&file=comparacao_arrays">Comparação entre Arrays</a></li>
        </ul>
    </div>
    <div class="modulo verde-escuro">
        <h3>6. Extruturas de repetição</h3>
        <ul>
    ...
    <div class="modulo roxo-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=includes&file=include_required">Include vs Require</a></li>
    ...
    <div class="modulo laranja">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=db&file=alterar_registro">Alterar Registro</a></li>
